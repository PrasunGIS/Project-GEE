// Define the region of interest (AOI) and time period
...
var headingTitle = ui.Label({
  value: 'LST Map of Kolkata District',
  style: {
    fontWeight: 'bold',
    fontSize: '18px',
    margin: '0 0 4px 0',
...
var headingTitle2 = ui.Label({
  value: 'NDVI Map of Kolkata District',
  style: {
    fontWeight: 'bold',
    fontSize: '18px',
    margin: '0 0 4px 0',
...
//  Palette with the colors
var NDVI_palette =  ["0008ff","ff0808","fffd2a","5aff5c","16b300"]

// name of the legend
var NDVI_names = ['Water Body','Settlement', 'Land', 'Low Vegetation', 'Dense Vegetation']
...
var dropdown = ui.Select({
  ...
  onChange: function(selected) {
    ...
    if (selected === 'Select a Map'){
      Map.addLayer(AOI.style({color: '000000',fillColor: '00000000',width: 1}),  {}, "Kolkata");
